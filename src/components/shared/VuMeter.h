...
class VuMeter : public ObsidianComponent
{
  public:
	VuMeter() = default;
	...
	void drawPeakSegments(int numSegments, juce::Rectangle<float> &vuArea, float segmentHeight, juce::Graphics &g,
	                      float peakValue);
  ...
  private:
	...
	void fillMeterSegment(juce::Graphics &g, juce::Rectangle<float> &vuArea, int i, float segmentHeight,
