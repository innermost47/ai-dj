...
void ObsidianModalWindow::addButton(const juce::String& text, const juce::String& svgData,
...
ObsidianModalOverlay::ObsidianModalOverlay(std::unique_ptr<ObsidianModalWindow> modal)
