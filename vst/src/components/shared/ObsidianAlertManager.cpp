...
ObsidianModalOverlay* ObsidianAlertManager::createAndAttachOverlay(
...
void ObsidianAlertManager::showInfo(
	juce::Component* parent,
...
void ObsidianAlertManager::showError(
	juce::Component* parent,
	const juce::String& title,
	const juce::String& message)
{
...
void ObsidianAlertManager::showConfirm(
	juce::Component* parent,
	const juce::String& title,
	const juce::String& message,
...
void ObsidianAlertManager::showConfigDialog(
	juce::Component* parent,
	const juce::String& title,
...
void ObsidianAlertManager::showCategoryEditor(
	juce::Component* parent,
...
void ObsidianAlertManager::showEditPrompt(
	juce::Component* parent,
...
void ObsidianAlertManager::showUpdateAvailable(
	juce::Component* parent,
