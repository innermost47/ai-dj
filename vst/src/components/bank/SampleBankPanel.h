...
private:
	...
	std::vector<CategoryInfo> categoryInfos = {
		{0, "All Samples"}, {1, "Drums"}, {2, "Bass"}, {3, "Melody"}, {4, "Ambient"}, {5, "Percussion"}, {6, "Vocal"}, {7, "FX"}, {8, "Loops"}, {9, "One-shots"}, {10, "House"}, {11, "Techno"}, {12, "Hip-Hop"}, {13, "Jazz"}, {14, "Rock"}, {15, "Electronic"}, {16, "Piano"}, {17, "Guitar"}, {18, "Synth"} };
