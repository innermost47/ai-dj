...
class AudioAnalyzer
{
  public:
	...
	static void timeStretchBufferHQ(juce::AudioBuffer<float> &buffer, double ratio, double sampleRate);

	static void timeStretchBuffer(juce::AudioBuffer<float> &buffer, double ratio, double sampleRate,
